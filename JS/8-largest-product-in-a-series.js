// Problem: Find the n adjacent digits in the 1000-digit number 
...
function largestProductinaSeries(n) {
    ...
    let max = 0;
    for (let i=0; i < thousandDigits.length - 13; i++) {
      let arr = thousandDigits.slice(i, i + 13);
      let product = arr.reduce((p, n) => p * n, 1);
      if (product > max) {
        max = product;
      }
    }
